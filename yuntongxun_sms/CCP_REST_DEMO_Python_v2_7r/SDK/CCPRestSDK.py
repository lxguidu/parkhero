...
from yuntongxun_sms.CCP_REST_DEMO_Python_v2_7r.SDK.xmltojson import xmltojson
...
class REST:
    ...
    def sendTemplateSMS(self, to,datas,tempId):
        ...
        self.Batch = nowdate.strftime("%Y%m%d%H%M%S")
        #生成sig
        signature = self.AccountSid.encode('utf-8')   + self.AccountToken.encode('utf-8')    + self.Batch.encode('utf-8');
        m = md5()
        m.update(signature)
        ...
        #req.add_data(body)
        req = Request(url, bytes(body, 'utf-8'))
